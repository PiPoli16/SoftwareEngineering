public class Member
{
    ...
    public void BorrowBook()
    {
        ...
        int max = GetMaxBorrowLimit();

        if (booksBorrowed < max)
        {
            booksBorrowed++;
            TotalBooksBorrowed++;
        }
        ...
        {
            Console.WriteLine($"{MemberName} has reached their borrowing limit.");
        }
    }
    ...
    public void ReturnBook()
    {
        ...
        if (booksBorrowed > 0)
        {
            ...
            if (booksBorrowed == 0)
            {
                Console.WriteLine($"{MemberName} has returned all their books.");
            }
        }
    }
