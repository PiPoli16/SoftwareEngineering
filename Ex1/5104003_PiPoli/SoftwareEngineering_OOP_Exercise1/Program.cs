public class Program
{
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine($"{alice.MemberName}, Age: {alice.Age}, Level: {alice.MembershipLevel}, Books Borrowed: {alice.GetBooksBorrowed()}");
        Console.WriteLine($"{bob.MemberName}, Age: {bob.Age}, Level: {bob.MembershipLevel}, Books Borrowed: {bob.GetBooksBorrowed()}");
        Console.WriteLine($"{charlie.MemberName}, Age: {charlie.Age}, Level: {charlie.MembershipLevel}, Books Borrowed: {charlie.GetBooksBorrowed()}");
        ...
        // - Use properties and the method for borrowed books
        // - Demonstrates reading instance and property data      
        Console.WriteLine($"\n{alice.MemberName}, Age: {alice.Age}, Level: {alice.MembershipLevel}, Books Borrowed: {alice.GetBooksBorrowed()}");
        Console.WriteLine($"{bob.MemberName}, Age: {bob.Age}, Level: {bob.MembershipLevel}, Books Borrowed: {bob.GetBooksBorrowed()}");
        Console.WriteLine($"{charlie.MemberName}, Age: {charlie.Age}, Level: {charlie.MembershipLevel}, Books Borrowed: {charlie.GetBooksBorrowed()}");
