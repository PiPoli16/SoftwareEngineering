public class Program
{
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine($"{m1.MemberName}, Age: {m1.Age}, Level: {m1.MembershipLevel}, Books Borrowed: {m1.GetBooksBorrowed()}");
        Console.WriteLine($"{m2.MemberName}, Age: {m2.Age}, Level: {m2.MembershipLevel}, Books Borrowed: {m2.GetBooksBorrowed()}");
        Console.WriteLine($"{m3.MemberName}, Age: {m3.Age}, Level: {m3.MembershipLevel}, Books Borrowed: {m3.GetBooksBorrowed()}");
        ...
        // - Use properties and the method for borrowed books
        // - Demonstrates reading instance and property data      
        Console.WriteLine($"\n{m1.MemberName}, Age: {m1.Age}, Level: {m1.MembershipLevel}, Books Borrowed: {m1.GetBooksBorrowed()}");
        Console.WriteLine($"{m2.MemberName}, Age: {m2.Age}, Level: {m2.MembershipLevel}, Books Borrowed: {m2.GetBooksBorrowed()}");
        Console.WriteLine($"{m3.MemberName}, Age: {m3.Age}, Level: {m3.MembershipLevel}, Books Borrowed: {m3.GetBooksBorrowed()}");
